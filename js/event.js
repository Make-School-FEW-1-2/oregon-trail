class Event {
  ...
  stateChangeEvent(eventData, caravan, ui) {
    ...
    if (eventData.value + this.caravan[eventData.stat] >= 0) {
      ...
      ui.notify(eventData.text + Math.abs(eventData.value), eventData.notification);
    }
  }

  static shopEvent(eventData, ui) {
    ...
    ui.showShop(products);
  }

  // TODO: is this thhe correct way to approach this?
  static attackEvent(ui, OregonH) {
